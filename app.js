...
function restoreLastPage(){const last=localStorage.getItem("mailLastPage")||"registerPage",page=$(last)?last:"registerPage";const menu=document.querySelector(`[onclick*="${page}"]`)||document.querySelector('[onclick*=registerPage]');showPage(page,menu)}
...
function openPendingPrint(){const menu=document.querySelector('[onclick*=sheetPage]');showPage("sheetPage",menu);$("sheetOnlyUnprinted").checked=true;$("sheetDate").value="";renderSheetPage()} window.openPendingPrint=openPendingPrint;
